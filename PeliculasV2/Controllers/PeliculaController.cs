...
public class PeliculaController : Controller
{
    ...
    public PeliculaController(IPeliculaRepository repo, IAuthenticationService authService, ILogger<PeliculaController> logger)
    {
        _peliRepo = repo;
    ...
    public IActionResult Index()
    {
        ...
        {
            // EL REQUISITO DEL PROFE: Guardar el error técnico y salir prolijo
